...
class PlayerView {
    ...
    initHandlers() {
        this.ready().then(() => {
            ...
            $(this).on('keydn-t               ', () => this.framewise_annotation());
            ...
            $(this).on('keydn-a keydnr-a keydn-arrowleft     ', () => {
                if (!this.loading)
                    this.video.previousFrame()
            });
            $(this).on('keydn-s keydnr-s keydn-arrowright    ', () => {
                if (!this.loading)
    ...
    framewise_annotation() {
        $(this).trigger('framewise-annotation');
    }
    // Time control
    stepforward() {
